...
<head>
  ...
  <style>
    ...
    .effects-box textarea { height: 76px; }
    .text-page-title {
      margin-bottom: 8px;
      padding-bottom: 8px;
      border-bottom: 2px solid var(--sheet-accent);
  ...
  <main class="sheet-shell">
    <form id="sheet" autocomplete="off">
      ...
      <section class="page">
        ...
        <div class="main-grid">
          <div class="stats-col">
            <div class="section-label" style="text-align:center">${escapeHtml(t.characteristics)}</div>
            ...
            <div class="health-block" style="margin-top:4px">
              <div class="section-label">${escapeHtml(t.exhaustion)}</div>
              <div class="health-row" style="justify-content:center">
                ${field("exhaustion-current", 'style="width:36px;font-size:18px;font-weight:700"')}
                <span style="color:var(--sheet-border)">/</span>
                ${field("exhaustion-threshold", 'style="width:36px;font-size:18px;font-weight:700"')}
              </div>
              <div class="health-formula" style="font-size:7px">${escapeHtml(t.exhaustionFormula)}</div>
              <div style="margin-top:5px;color:#7a5c3a;font-size:7px;line-height:1.35">
          ...
          <div class="right-col">
            ...
            <div class="health-block">
              ...
              <div class="death-row"><div class="section-label" style="margin-bottom:0">${escapeHtml(t.dying)}</div><div class="death-circles circle-track">${circles("dying", 3)}</div></div>
            </div>
            <div class="inspiration-block">
              <div class="inspiration-row"><div class="section-label" style="margin-bottom:0">${escapeHtml(t.inspiration)}</div><div class="inspiration-marks circle-track" aria-label="${escapeHtml(t.inspiration)}">${circles("insp", 3)}</div></div>
              <div class="inspiration-row"><div class="section-label" style="margin-bottom:0">${escapeHtml(t.antiInspiration)}</div><div class="inspiration-marks circle-track" aria-label="${escapeHtml(t.antiInspiration)}">${circles("anti-insp", 3)}</div></div>
            </div>
